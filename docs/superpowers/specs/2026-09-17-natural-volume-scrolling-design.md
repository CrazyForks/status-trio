...
- 英文说明：`When on, scrolling up on a mouse or trackpad increases volume. When off, volume follows the system's scrolling direction.`
- 简体中文标题：`自然滚动`
- 简体中文说明：`开启后，鼠标和触控板上滚都会增大音量；关闭后，音量跟随系统的滚动方向。`
