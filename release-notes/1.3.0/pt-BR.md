...
- O macOS 15 e posteriores não são afetados; a versão mínima do sistema não muda, então ninguém precisa atualizar o macOS para continuar usando o Status Trio.
