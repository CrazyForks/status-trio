...
<p align="center">
  <img src="screenshots/popup.png" width="360" alt="Status Trio 状态弹层，展示 macOS 菜单栏中的电池、Wi-Fi、蓝牙和音量">
</p>
...
三合一图标支持的全部状态，均由应用自身的渲染器绘制 —— 顶部是电池指示，中部是 Wi-Fi 状态（蓝牙音频设备会取代它），底部是音量圆点或圆弧，播放蓝牙音频时会变成蓝色：
