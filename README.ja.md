...
- **Wi-Fi** — 接続中のネットワークと電波の強さ。開くと、近くのネットワークの表示、接続、Wi-Fi のオフができます。
